...
if __name__ == '__main__':
    ...
    res5 = delivery.testGetOrder(51, 1000, "return", 201, 200)
    if res5.json()["orderId"] == 1000 and res5.json()["status"] == "assigned":
        test_pass()
    res5 = delivery.testGetOrder(56, 1001, "return", 202, 200)
    if res5.json()["orderId"] == 1001 and res5.json()["status"] == "assigned":
        test_pass()
    res5 = delivery.testGetOrder(57, 1002, "return", 203, 200)
    if res5.json()["orderId"] == 1002 and res5.json()["status"] == "assigned":
        test_pass()
    ...
    res5 = delivery.testGetOrder(81, 1000, "return", 201, 200)
    if res5.json()["orderId"] == 1000 and res5.json()["status"] == "delivered":
        test_pass()
    res5 = delivery.testGetOrder(82, 1001, "return", 202, 200)
    if res5.json()["orderId"] == 1001 and res5.json()["status"] == "delivered":
        test_pass()
    res5 = delivery.testGetOrder(57, 1002, "return", 203, 200)
    if res5.json()["orderId"] == 1002 and res5.json()["status"] == "assigned":
        test_pass()
