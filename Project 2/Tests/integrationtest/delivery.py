...
def testGetAgent(t, agentId, agentStatus, statuscode):
    print(str(t) + ".\tdelivery request\t- get /agent/" +
          str(agentId) + "\t\t", end="")
    try:
...
def testRequestOrder(t, custId, restId, itemId, qty, statuscode, orderId=0):
    statuscode = 201
    ...
    try:
        ...
        if response.status_code == statuscode and (response.json()["orderId"] == orderId or orderId == -1):
            test_pass()
        else:
            test_fail()
...
def testGetOrder(t, orderId, status, statuscode):
    print(str(t) + ".\tdelivery request\t- get /order/" +
          str(orderId) + "\t\t", end="")
    print("Desired : OrderId = ", orderId, "Status=", status)
    try:
        ...
        if response.status_code == statuscode:
            if (status is not None):
                if (response.json()["status"] == status and response.json()["orderId"] == orderId):
                    test_pass()
                else:
                    test_fail()
                    print(response.json())
...
if __name__ == "__main__":
    ...
    print_box(
        "\033[93mDelivery Service API Test (Project 1 Phase 1) \033[1;32;40m")
    ...
    # ---------------------  /requestOrder  --------------------
    testRequestOrder(20, 301, 101, 2, 10, 201, 1000)
    testRequestOrder(21, 302, 101, 2, 11, 201, 1001)
    ...
    # ---------------------  /requestOrder  --------------------
    testRequestOrder(24, 301, 101, 2, 10, 201, 1002)
    testRequestOrder(25, 302, 101, 2, 11, 201, 1003)

    # ---------------------  /getOrder  ------------------------
    testGetOrder(26, 1000, "unassigned", 200)
    # testAgentSignIn(27, 201, 201)
    testGetOrder(28, 1001, "unassigned", 200)
    sleep(1)
    testGetOrder(28, 1002, "delivered", 200)
    testGetOrder(28, 1001, "unassigned", 200)
    ...
    wallet.testDeductBalance(68, 301, 1700, 201)
    order = [{"restId": 101, "itemId": 2, "qty": 0}]
    qty = int(restaurant.testOrder(18, order, "getRestaurantItem", 200).content)
    testRequestOrder(33, 301, 101, 2, 3, 201, 1000)
    testGetOrder(34, 1000, "unassigned", 200)
    wallet.testGetBalance(35, 301, 300, 200)
    if qty == int(restaurant.testOrder(18, order, "getRestaurantItem", 200).content):
        test_pass()
    ...
    testRequestOrder(33, 301, 101, 2, 10, 201, 1000)
    ...
    testRequestOrder(38, 301, 101, 2, 1, 201, 1000)
    testRequestOrder(39, 301, 101, 1, 1, 201, 1001)
    testRequestOrder(40, 302, 101, 1, 1, 201, 1002)
    testRequestOrder(41, 302, 102, 1, 1, 201, 1003)
    testRequestOrder(42, 303, 102, 4, 1, 201, 1004)
    testGetOrder(43, 1000, "delivered", 200)
    testGetOrder(44, 1001, "delivered", 200)
    testGetOrder(45, 1002, "delivered", 200)
    # testAgentSignIn(46, 201, 201)

    # testAgentSignIn(50, 203, 201)

    testGetOrder(51, 1002, "delivered", 200)
    # testOrderDelivered(52, 1000, 201)
    # testOrderDelivered(53, 1001, 201)
    testGetOrder(54, 1000, "delivered", 200)
    testGetOrder(55, 1001, "delivered", 200)
    testGetOrder(51, 1002, "delivered",  200)
    testGetOrder(56, 1003, "delivered", 200)
    testGetOrder(57, 1004, "delivered", 200)
    ...
    testRequestOrder(61, 301, 101, 2, 10, 201, 1000)
    wallet.testGetBalance(62, 301, 2000, 200)

    wallet.testAddBalance(63, 301, 300, 201)
    testRequestOrder(64, 301, 101, 2, 10, 201, 1001)
    # testGetOrder(65, 1000, "unassigned", 200)
    ...
    testRequestOrder(70, 301, 101, 2, 21, 201, 1002)
    wallet.testGetBalance(71, 301, 4830, 200)
    testRequestOrder(72, 301, 101, 2, 20, 201, 1003)
    ...
    testRequestOrder(78, 301, 101, 2, 1, 201, 1000)
    testGetOrder(79, 1000, "delivered", 200)
    testRequestOrder(80, 301, 101, 2, 1, 201, 1001)
    # testOrderDelivered(81, 1000, 201)
    testRequestOrder(82, 301, 101, 2, 1, 201, 1002)
    testGetOrder(83, 1002, "delivered", 200)
    testGetOrder(84, 1001, "delivered", 200)
    testGetOrder(85, 1000, "delivered", 200)
    ...
    testRequestOrder(90, 301, 101, 2, 1, 201, 1000)
    testRequestOrder(91, 301, 101, 2, 1, 201, 1001)
    testRequestOrder(92, 301, 101, 2, 1, 201, 1002)
    # testOrderDelivered(93, 1000, 201)
    testGetOrder(94, 1000, "delivered", 200)
    testGetOrder(95, 1001, "delivered", 200)
    testGetOrder(96, 1002, "delivered", 200)
    ...
    testRequestOrder(101, 301, 101, 2, 1, 201, 1000)
    # testOrderDelivered(102, 1000, 201)
    testGetOrder(103, 1000, "delivered", 200)
